                    ...
                    <button type="button" class="btn" id="page-header-user-dropdown" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        <span class="d-flex align-items-center">
                            ...
                            <span class="text-start ms-xl-2">
                                ...
                                <span class="d-none d-xl-block ms-1 fs-12 text-muted user-name-sub-text"><?= nivel_access(session('user')['admin']) ?></span>
                            </span>
                        </span>
                    </button>
                    <div class="dropdown-menu dropdown-menu-end">
                        <!-- item-->
                        <h6 class="dropdown-header">Bem vindo(a) <?= session('user')['name'] ?>!</h6>
                        ...
                        <a class="dropdown-item" href="pages-profile">
                            ...
                            <span class="align-middle">Balanço : <b>R$0.00</b></span>
                        </a>
